...
public class BleController {
    ...
    //TODO 以下uuid根据公司硬件改变
    public static final String UUID_SERVICE = "0000000-0000-0000-0000-000000001000";

    //public static final String UUID_SERVICE = "7cf9d61b-70c7-4b2e-9466-55c362ef16c0";
    ...
    public static final String UUID_WRITE = "0000000-0000-0000-0000-000000001005";
    //public static final String UUID_WRITE = "d1a7c7b0-a7aa-4a93-9dfe-d09dd6245294";
    public static final String UUID_READ = "0000000-0000-0000-0000-000000001004";
    ...
    private class BleGattCallback extends BluetoothGattCallback {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            ...
            if (null != mBleGatt && status == BluetoothGatt.GATT_SUCCESS) {
                ...
                BluetoothGattCharacteristic NotificationCharacteristic=getBluetoothGattCharacteristic(UUID_SERVICE,UUID_WRITE);
